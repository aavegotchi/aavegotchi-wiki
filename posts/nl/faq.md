...
Nee. The aTokens staked inside an Aavegotchi cannot be used as collateral for borrowing on the Aave platform. Thus, such aTokens cannot get liquidated.
...
Nee. The [Aaavegotchi.com website](https://aavegotchi.com/) is just an interface. Bots would still easily bypass the interface and interact with the underlying smart contract directly.

This is a feature of permissionless blockchains. It cannot be stopped.

### Are amTokens the same as maTokens?
Nee. amTokens are **not** the same as maTokens.
