...
* Voor meer op [Aragon Fundraising en binding curves!](https://web.archive.org/web/*/https://fundraising.aragon.black/components/bonding-curve)
...
* Artikel over [DAICO](https://web.archive.org/web/*/https://cointelegraph.com/explained/what-is-a-daico-explained) van de Coin Telegraph.