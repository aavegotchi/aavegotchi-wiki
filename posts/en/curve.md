...
title: 'Bonding Curve'
description: "Learn how the GHST bonding curve works, including price-supply mechanics, treasury effects, and historical tokenomics context."
...
* For more on [Aragon Fundraising and bonding curves!](https://web.archive.org/web/*/https://fundraising.aragon.black/components/bonding-curve)
...
* Article on [DAICO](https://web.archive.org/web/*/https://cointelegraph.com/explained/what-is-a-daico-explained) by the Coin Telegraph.
