...
Installations and their upgrades have a “Build Time”, which is measured in **blocks**. Historically, this page referenced Polygon block-times for a rough human-time conversion; after the migration to **Base**, block times differ and can change over time. Use the in-game UI as the source of truth for timing.
