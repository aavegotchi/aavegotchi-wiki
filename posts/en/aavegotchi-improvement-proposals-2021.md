...
description: "Archive of Aavegotchi Improvement Proposals (AGIPs) for 2021, including proposal context, voting windows, and recorded outcomes."
contributors: ["unintelligent-nerd"]
---

> **Note (Base era):** As of **2025-07-25**, Aavegotchi’s canonical home has migrated to **Base**. This page is an **archive** of 2021-era governance proposals and contains historical Polygon-era assumptions and time-bound language. For current chain context, see **[Migration to Base (2025)](/base-migration)** and **[Contracts](/contracts)**.
