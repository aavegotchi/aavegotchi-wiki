...
Подробней об этом можно почитать [тут](https://web.archive.org/web/*/https://aavegotchi.medium.com/why-aavegotchi-chose-polygon-356238977fb2).
...
Новый URL-адрес RPC: https://web.archive.org/web/*/https://rpc-mainnet.maticvigil.com/.
