...
- Étape 1 : Visitez [aavegotchi.com/stake-gltr](https://aavegotchi.com/stake-gltr). 7 pools : wapGHST, GHST‑FUD, GHST‑FOMO, GHST‑ALPHA, GHST‑KEK, GHST‑USDC, GHST‑GLTR. Si « not functional on Base », passez à Polygon ou via aavegotchi.com.
